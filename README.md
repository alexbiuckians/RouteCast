...
![pipeline](dashboard/preview.png) <!-- optional: screenshot the dashboard and save as dashboard/preview.png -->
...
**Feature importance:** the two engineered history features — `zone_avg_min` (46%) and `courier_avg_min` (17%) — account for **~63%** of the model's predictive gain, confirming that *where* a parcel is going and *who* carries it dominate raw distance.
